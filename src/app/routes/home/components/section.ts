...
/**
 * A component containing a Subtitle component for the title and a div component
 * for its content.
 */
export class Section extends Component<HTMLDivElement> {
  ...
  public constructor(
      title: string,
      content: Component<HTMLDivElement> | string,
  ) {
    super(
      'section',
      {
          ...
          new Component(
            'div',
            {
              ...
              classList: typeof content === 'string'
                ...
                : [
                  classes['home-section-content'],
                  ...content.dom.classList,
                ],
            },
          ),
        ],
        classList: [classes['home-section']],
      },
    )
  }
}
