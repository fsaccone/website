import { getAboutMe } from '../sections/about-me'
import { getProjectsComponent } from '../sections/projects'
import { getSkillsComponent } from '../sections/skills'
 ...
 * This is to divide the sections in two columns when the screen is in landscape.
 */
