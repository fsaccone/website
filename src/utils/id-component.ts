...
/**
 * A map containing all the components with an id, stored with the id as the key.
 */
...
const getComponentById = (id: string): Component<HTMLElement> | null => idComponents.get(id) ?? null
